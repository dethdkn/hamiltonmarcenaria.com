...
defineProps({ title: { type: String, default: 'Hamilton Marcenaria Moderna' } })
</script>

<template>
  <div class="relative flex size-full items-start justify-start bg-white">
    <h1 class="p-20 text-center text-7xl font-bold text-gray-900">
      {{ title }}
    </h1>
